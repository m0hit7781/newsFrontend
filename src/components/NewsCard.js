  ...
  return (
    <div className="newscard">
      ...
      <h3>
        ...
        <div className="newscardpostdata">
          <p className="timeagocard">2 hours ago</p>
          <p className="postedbycard">By {news.author} |</p>
          <p className="minutereadcard">4min read</p>
        </div>
        <div className="sharecard bordershare">
